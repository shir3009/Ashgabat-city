! function(t) {
    ...
    function Ps(t) {
        if (-1 === t.indexOf("linear-gradient") || -1 !== t.indexOf("deg") && -1 === t.indexOf("180deg")) return t;
    ...
    bs.getSSGColors = function(t, e, n) {
        ...
        var u = Ss(t),
            s = Ss(e);
        if (t = Ps(t), e = Ps(e), u.stops.length === s.stops.length && -1 !== t.indexOf("gradient") && -1 !== e.indexOf("gradient")) return {
            from: t,
            to: e
        };
        var o, a, l = u.stops;
